...
type
  TCQuerySelectMySQL = class(TCQuerySelect)
  public
...
uses
  ...
  CQuery.Register,
  CQuery.Interfaces,
  CQuery.QualifierMySQL;

{ TCQuerySelectMySQL }

constructor TCQuerySelectMySQL.Create;
begin
  inherited;
  FQualifiers := TCQuerySelectQualifiersMySQL.Create;
end;

function TCQuerySelectMySQL.Serialize: String;
begin
  if IsEmpty then
    Result := ''
  else
