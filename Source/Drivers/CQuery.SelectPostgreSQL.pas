...
type
  TCQuerySelectPostgreSQL = class(TCQuerySelect)
  public
...
uses
  ...
  CQuery.Register,
  CQuery.Interfaces,
  CQuery.QualifierPostgresql;

{ TCQuerySelectPostgreSQL }

constructor TCQuerySelectPostgreSQL.Create;
begin
  inherited;
  FQualifiers := TCQuerySelectQualifiersPostgreSQL.Create;
end;

function TCQuerySelectPostgreSQL.Serialize: String;
begin
  if IsEmpty then
    Result := ''
  else
