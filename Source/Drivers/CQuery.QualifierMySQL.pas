...
type
  TCQuerySelectQualifiersMySQL = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersMySQL }

function TCQuerySelectQualifiersMySQL.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
begin
  ...
  begin
    case FQualifiers[LFor].Qualifier of
      ...
      raise Exception.Create('TCQuerySelectQualifiersMySQL.SerializeSelectQualifiers: Unknown qualifier');
    end;
  end;
