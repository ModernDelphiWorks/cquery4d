...
unit CQuery.QualifierPostgreSQL;
...
type
  TCQuerySelectQualifiersPostgreSQL = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersPostgreSQL }

function TCQuerySelectQualifiersPostgreSQL.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
begin
  ...
  begin
    case FQualifiers[LFor].Qualifier of
      ...
      raise Exception.Create('TCQuerySelectQualifiersPostgreSQL.SerializeSelectQualifiers: Unknown qualifier');
    end;
  end;
