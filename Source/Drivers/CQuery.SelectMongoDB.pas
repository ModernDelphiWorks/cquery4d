...
type
  TCQuerySelectMongoDB = class(TCQuerySelect)
  public
...
uses
  ...
  CQuery.Register,
  CQuery.Interfaces,
  CQuery.QualifierMongoDB;

{ TCQuerySelectMongoDB }

constructor TCQuerySelectMongoDB.Create;
begin
  inherited;
  FQualifiers := TCQuerySelectQualifiersMongodb.Create;
end;

function TCQuerySelectMongoDB.Serialize: String;
begin
  if IsEmpty then
    Result := ''
  else
