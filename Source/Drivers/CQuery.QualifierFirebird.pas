...
type
  TCQuerySelectQualifiersFirebird = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersFirebird }

function TCQuerySelectQualifiersFirebird.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
