...
type
  TCQuerySelectSQLite = class(TCQuerySelect)
  public
...
uses
  ...
  CQuery.Register,
  CQuery.Interfaces,
  CQuery.QualifierSQLite;

{ TCQuerySelectSQLite }

constructor TCQuerySelectSQLite.Create;
begin
  inherited;
  FQualifiers := TCQuerySelectQualifiersSQLite.Create;
end;

function TCQuerySelectSQLite.Serialize: String;
begin
  if IsEmpty then
    Result := ''
  else
