...
type
  TCQuerySelectQualifiersOracle = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersOracle }

function TCQuerySelectQualifiersOracle.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
