...
type
  TCQuerySelectFirebird = class(TCQuerySelect)
  public
...
{ TCQuerySelectFirebird }

constructor TCQuerySelectFirebird.Create;
begin
  inherited;
  FQualifiers := TCQuerySelectQualifiersFirebird.Create;
end;

function TCQuerySelectFirebird.Serialize: String;
begin
  if IsEmpty then
    Result := ''
  else
