...
unit CQuery.QualifierInterbase;
...
type
  TCQuerySelectQualifiersinterbase = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersinterbase }

function TCQuerySelectQualifiersinterbase.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
