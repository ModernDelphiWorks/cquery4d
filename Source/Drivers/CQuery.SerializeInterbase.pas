...
unit CQuery.SerializeInterbase;
...
type
  TCQuerySerializerInterbase = class(TCQuerySerialize)
  public
...
{ TCQuerySerializerInterbase }

function TCQuerySerializerInterbase.AsString(const AAST: ICQueryAST): String;
begin
