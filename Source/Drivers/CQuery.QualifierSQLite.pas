...
type
  TCQuerySelectQualifiersSQLite = class(TCQuerySelectQualifiers)
  public
...
{ TCQuerySelectQualifiersSQLite }

function TCQuerySelectQualifiersSQLite.SerializePagination: String;
var
  LFor: Integer;
  LFirst: String;
  LSkip: String;
begin
  ...
  begin
    case FQualifiers[LFor].Qualifier of
      ...
      raise Exception.Create('TCQuerySelectQualifiersSQLite.SerializeSelectQualifiers: Unknown qualifier');
    end;
  end;
