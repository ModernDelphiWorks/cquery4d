...
type
  ...
  public
    constructor Create(const ADatabase: TDBName; const ARegister: TCQLRegister);
...
constructor TCQLAST.Create(const ADatabase: TDBName; const ARegister: TCQLRegister);
begin
  FRegister := ARegister;
