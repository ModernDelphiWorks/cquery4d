...
type
  TCQuerySerialize = class(TInterfacedObject, ICQuerySerialize)
  public
    function AsString(const AAST: ICQueryAST): String; virtual;
  end;

implementation

function TCQuerySerialize.AsString(const AAST: ICQueryAST): String;
begin
